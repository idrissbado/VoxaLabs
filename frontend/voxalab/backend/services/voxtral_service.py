...
async def transcribe_audio(audio_base64: str) -> str:
    """
    Transcribe audio for interview practice.
    In production, this would use Voxtral-Realtime for real-time transcription.
    For now, returns a sample transcription for testing.
    """
    # For hackathon demo: return a realistic sample answer
    # This demonstrates the system flow without requiring actual audio processing
    sample_answer = ("Um, so when I was working at my previous company, like, we had this issue "
                     "with the deployment pipeline. Basically, I was responsible for making sure our "
                     "services were running smoothly. I decided to implement a new CI/CD system that "
                     "would automate the whole process. As a result, we reduced deployment time by 80% "
                     "and increased our release frequency from once a month to multiple times a day.")
